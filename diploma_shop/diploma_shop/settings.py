"""
Django settings for diploma_shop project.
...
SECRET_KEY = 'django-insecure-h0uq6vm)3s-8=6vxaermmwm&r8x_cy&su_ckyn7bgmx*+)tej$'
...
ROOT_URLCONF = 'diploma_shop.urls'
...
WSGI_APPLICATION = 'diploma_shop.wsgi.application'
